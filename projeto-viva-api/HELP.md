...
* The original package name 'com.projeto-viva' is invalid and this project uses 'com.projeto.viva' instead.
...
```
$ docker run --rm -p 8080:8080 projeto-viva:0.0.1-SNAPSHOT
```
